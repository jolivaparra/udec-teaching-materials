...
\begin{solucion}
    ...
    Notamos que por simetría las componentes horizontales y verticales debiesen anularse por completo entre sí, nicamente la componente vertical. Por lo tanto la expresión resultante es:
