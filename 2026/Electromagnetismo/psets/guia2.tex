...
\begin{solucion}
    ...
    Lo siguiente es que notamos que cada elemento infinitesimal de la curva produce exactamente la misma \textbf{magnitud} de campo eléctrico sobre el punto $P$ al ubicarse a la misma distancia de este. Esta magnitud estará dada por:
    \begin{equation}
...
\problema[Distribución de Carga Superficial] Considere un plano infinito que coincide con el plano $xy$ ($z = 0$), el cual posee una densidad de carga superficial uniforme $\sigma$. Exprese la integral que permite calcular la magnitud del campo eléctrico que esta ejerce sobre una carga ubicada en $P=h\hat{z}$.
...
\problema[Distribución de Carga Volumétrica]
